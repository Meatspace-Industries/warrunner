...
_WORKFLOW_RUN_PASSTHROUGH_ENV_NAMES = (
    "AGENT_IMAGE",
    "CENTAUR_DEPLOYMENT_NAME",
    "CENTAUR_DISABLED_INFRA_SECRETS",
    "CENTAUR_OVERLAY_IMAGE",
    "CENTAUR_OVERLAY_IMAGE_PULL_POLICY",
    "CENTAUR_OVERLAY_IMAGE_SOURCE_PATH",
    "CENTAUR_OVERLAY_DIR",
    ...
    "GITHUB_API_URL",
    "GITHUB_ETL_ENABLED",
    "GITHUB_CONTEXT_DOCUMENTS_ENABLED",
    "GITHUB_CONTEXT_DOCUMENTS_INTERVAL_SECONDS",
    "GITHUB_CONTEXT_DOCUMENTS_MAX_PAGES_PER_REPO",
    "FIREWALL_MANAGER_SECRET_SOURCE",
    "FIREWALL_MANAGER_SECRET_TTL",
    "FIREWALL_MANAGER_TOKEN_BROKER_STORE_SOURCE",
    "FIREWALL_MANAGER_TOKEN_BROKER_TTL",
    "IRON_TOKEN_BROKER_FILE_STORE_DIR",
    "KUBERNETES_AGENT_IMAGE_PULL_POLICY",
    "KUBERNETES_API_POD_LABEL_SELECTOR",
    "KUBERNETES_BOOTSTRAP_SECRET_NAME",
    "KUBERNETES_CODEX_AUTH_SECRET_KEY",
    "KUBERNETES_CODEX_AUTH_SECRET_NAME",
    "KUBERNETES_FIREWALL_CA_KEY_SECRET_NAME",
    "KUBERNETES_FIREWALL_CA_SECRET_NAME",
    "KUBERNETES_FIREWALL_MANAGER_SECRET_SOURCE",
    "KUBERNETES_IRON_PROXY_HEALTH_PORT",
    "KUBERNETES_IRON_PROXY_IMAGE",
    "KUBERNETES_IRON_PROXY_IMAGE_PULL_POLICY",
    "KUBERNETES_IRON_PROXY_MANAGEMENT_PORT",
    "KUBERNETES_IRON_PROXY_PORT",
    "KUBERNETES_OP_CONNECT_APP_NAME",
    "KUBERNETES_OP_CONNECT_HOST",
    "KUBERNETES_OP_CONNECT_PORT",
    "KUBERNETES_SANDBOX_CONTROLLER",
    "KUBERNETES_SANDBOX_CPU_LIMIT",
    "KUBERNETES_SANDBOX_CPU_REQUEST",
    "KUBERNETES_SANDBOX_EXTRA_ENV",
    "KUBERNETES_SANDBOX_IMAGE_PULL_SECRETS",
    "KUBERNETES_SANDBOX_MEMORY_LIMIT",
    "KUBERNETES_SANDBOX_MEMORY_REQUEST",
    "KUBERNETES_SANDBOX_READY_TIMEOUT_S",
    "KUBERNETES_SANDBOX_RUNTIME_CLASS_NAME",
    "KUBERNETES_SANDBOX_SERVICE_ACCOUNT_NAME",
    "KUBERNETES_SANDBOX_STATE_VOLUME_ENABLED",
    "KUBERNETES_SANDBOX_STATE_VOLUME_SIZE",
    "KUBERNETES_SANDBOX_STATE_VOLUME_STORAGE_CLASS",
    "KUBERNETES_SECRET_ENV_NAME",
    "KUBERNETES_SECRET_ENV_PREFIX",
    "KUBERNETES_TOKEN_BROKER_NAME",
    "KUBERNETES_TOKEN_BROKER_URL",
    "KUBERNETES_TOOL_SERVER_IMAGE",
    "KUBERNETES_TOOL_SERVER_IMAGE_PULL_POLICY",
    "KUBERNETES_TOOL_SERVER_PORT",
    "KUBERNETES_TOOL_SERVER_TOOL_DIRS",
    "WARRUNNER_ALLOWED_GITHUB_REPOS",
    "WARRUNNER_DAILY_BRIEF_CHANNEL_ID",
