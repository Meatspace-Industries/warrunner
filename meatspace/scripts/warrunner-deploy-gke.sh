...
DEFAULT_HOME_CHANNEL_IDS="1508220472569888950,1503278366080368822"
DEFAULT_ALLOWED_ROLE_IDS="1494022319855894579,1494022320438902886,1494022325862137876"
DEFAULT_MENTION_ROLE_IDS="1508633681919742116"
...
MENTION_ROLE_IDS="${WARRUNNER_MENTION_ROLE_IDS:-$(env_value WARRUNNER_MENTION_ROLE_IDS)}"
MENTION_ROLE_IDS="${MENTION_ROLE_IDS:-$DEFAULT_MENTION_ROLE_IDS}"
HELM_MENTION_ROLE_IDS="${MENTION_ROLE_IDS//,/\\,}"
...
helm_args=(
  ...
  --set-string "discordbot.mentionRoleIds=$HELM_MENTION_ROLE_IDS"
)
